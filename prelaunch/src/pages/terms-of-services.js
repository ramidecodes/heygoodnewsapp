...
const NotFoundPage = () => (
  <Layout darkText>
    ...
    <h1>HeyGoodNews Terms of Service</h1>
    <h2>1. Terms</h2>
    <p>
      By accessing the website at{' '}
      <a href="https://heygood.news">https://heygood.news</a>, you are agreeing
    ...
    <ol type="a">
      <li>
        ...
        (information or software) on HeyGoodNews' website for personal,
      ...
      <li>
        ...
        restrictions and may be terminated by HeyGoodNews at any time. Upon
    ...
    <ol type="a">
      <li>
        The materials on HeyGoodNews' website are provided on an 'as is' basis.
        HeyGoodNews makes no warranties, expressed or implied, and hereby
      ...
      <li>
        Further, HeyGoodNews does not warrant or make any representations
    ...
    <h2>4. Limitations</h2>
    <p>
      In no event shall HeyGoodNews or its suppliers be liable for any damages
      ...
      materials on HeyGoodNews' website, even if HeyGoodNews or a HeyGoodNews
    ...
    <p>
      The materials appearing on HeyGoodNews' website could include technical,
      typographical, or photographic errors. HeyGoodNews does not warrant that
      any of the materials on its website are accurate, complete or current.
      HeyGoodNews may make changes to the materials contained on its website at
      any time without notice. However HeyGoodNews does not make any commitment
      to update the materials.
    </p>
    <h2>6. Links</h2>
    <p>
      HeyGoodNews has not reviewed all of the sites linked to its website and is
      not responsible for the contents of any such linked site. The inclusion of
      any link does not imply endorsement by HeyGoodNews of the site. Use of any
      such linked website is at the user's own risk.
    </p>
    <h2>7. Modifications</h2>
    <p>
      HeyGoodNews may revise these terms of service for its website at any time
